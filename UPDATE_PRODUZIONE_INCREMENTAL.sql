...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250909151511_SyncOrdiniProduzioneTabelle'
)
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250909152713_AddCentriLavoro'
)
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250910070740_AddLavorazioniTable'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250910090304_ModifyLavorazioniFields'
)
BEGIN
...
BEGIN
    ...
    EXEC(N'UPDATE [Lavorazioni] SET [DescrizioneLavorazione] = N'''' WHERE [DescrizioneLavorazione] IS NULL');
...
BEGIN
    EXEC(N'CREATE UNIQUE INDEX [IX_Lavorazioni_CodiceLavorazione] ON [Lavorazioni] ([CodiceLavorazione]) WHERE [CodiceLavorazione] IS NOT NULL');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250910151604_AddIdLavorazioneToListaOP_v2'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250910152352_MakeIdLavorazioneRequired'
)
BEGIN
    ...
    EXEC(N'UPDATE [ListaOP] SET [IdLavorazione] = 0 WHERE [IdLavorazione] IS NULL');
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-08-11T17:23:50.4531098+02:00''
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-08-16T17:23:50.4531106+02:00''
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-08-21T17:23:50.4531109+02:00''
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-08-26T17:23:50.4531113+02:00''
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-08-31T17:23:50.4531116+02:00''
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-09-05T17:23:50.4531120+02:00''
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-07-22T17:23:50.4531123+02:00''
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250915094844_ChangeQuantitaDecimalPrecision'
)
BEGIN
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-08-16T11:48:42.3950091+02:00''
    WHERE [IdLavorazione] = 1;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-08-21T11:48:42.3950097+02:00''
    WHERE [IdLavorazione] = 2;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-08-26T11:48:42.3950100+02:00''
    WHERE [IdLavorazione] = 3;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-08-31T11:48:42.3950103+02:00''
    WHERE [IdLavorazione] = 4;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-09-05T11:48:42.3950106+02:00''
    WHERE [IdLavorazione] = 5;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-09-10T11:48:42.3950111+02:00''
    WHERE [IdLavorazione] = 6;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-07-27T11:48:42.3950113+02:00''
    WHERE [IdLavorazione] = 7;
    SELECT @@ROWCOUNT');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250915122930_ChangeTempoCicloTempoSetupToFloat'
)
BEGIN
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-08-16T14:29:29.1791790+02:00''
    WHERE [IdLavorazione] = 1;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-08-21T14:29:29.1791802+02:00''
    WHERE [IdLavorazione] = 2;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-08-26T14:29:29.1791811+02:00''
    WHERE [IdLavorazione] = 3;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-08-31T14:29:29.1791820+02:00''
    WHERE [IdLavorazione] = 4;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-09-05T14:29:29.1791823+02:00''
    WHERE [IdLavorazione] = 5;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-09-10T14:29:29.1791829+02:00''
    WHERE [IdLavorazione] = 6;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-07-27T14:29:29.1791835+02:00''
    WHERE [IdLavorazione] = 7;
    SELECT @@ROWCOUNT');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20251018063601_AddPercentualeInclusioneToOrdiniRighe'
)
BEGIN
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-09-18T08:36:00.2300047+02:00''
    WHERE [IdLavorazione] = 1;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-09-23T08:36:00.2300056+02:00''
    WHERE [IdLavorazione] = 2;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-09-28T08:36:00.2300060+02:00''
    WHERE [IdLavorazione] = 3;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-10-03T08:36:00.2300064+02:00''
    WHERE [IdLavorazione] = 4;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-10-08T08:36:00.2300068+02:00''
    WHERE [IdLavorazione] = 5;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-10-13T08:36:00.2300073+02:00''
    WHERE [IdLavorazione] = 6;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-08-29T08:36:00.2300076+02:00''
    WHERE [IdLavorazione] = 7;
    SELECT @@ROWCOUNT');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20251018065708_UpdateProgressiviArticoliRemoveFieldsAndRenameOrdinato'
)
BEGIN
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-09-18T08:57:07.4190106+02:00''
    WHERE [IdLavorazione] = 1;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-09-23T08:57:07.4190112+02:00''
    WHERE [IdLavorazione] = 2;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-09-28T08:57:07.4190115+02:00''
    WHERE [IdLavorazione] = 3;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-10-03T08:57:07.4190118+02:00''
    WHERE [IdLavorazione] = 4;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-10-08T08:57:07.4190121+02:00''
    WHERE [IdLavorazione] = 5;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-10-13T08:57:07.4190124+02:00''
    WHERE [IdLavorazione] = 6;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-08-29T08:57:07.4190127+02:00''
    WHERE [IdLavorazione] = 7;
    SELECT @@ROWCOUNT');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20251018070724_RemoveImpegnatoTotaleAndPrenotatoFromProgressiviArticoli'
)
BEGIN
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-09-18T09:07:23.6527560+02:00''
    WHERE [IdLavorazione] = 1;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-09-23T09:07:23.6527572+02:00''
    WHERE [IdLavorazione] = 2;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-09-28T09:07:23.6527575+02:00''
    WHERE [IdLavorazione] = 3;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-10-03T09:07:23.6527578+02:00''
    WHERE [IdLavorazione] = 4;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-10-08T09:07:23.6527581+02:00''
    WHERE [IdLavorazione] = 5;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-10-13T09:07:23.6527583+02:00''
    WHERE [IdLavorazione] = 6;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-08-29T09:07:23.6527586+02:00''
    WHERE [IdLavorazione] = 7;
    SELECT @@ROWCOUNT');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20251018071537_ChangeDecimalPrecisionProgressiviArticoli'
)
BEGIN
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-09-18T09:15:37.0612894+02:00''
    WHERE [IdLavorazione] = 1;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-09-23T09:15:37.0612900+02:00''
    WHERE [IdLavorazione] = 2;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-09-28T09:15:37.0612903+02:00''
    WHERE [IdLavorazione] = 3;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-10-03T09:15:37.0612906+02:00''
    WHERE [IdLavorazione] = 4;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-10-08T09:15:37.0612909+02:00''
    WHERE [IdLavorazione] = 5;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-10-13T09:15:37.0612912+02:00''
    WHERE [IdLavorazione] = 6;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-08-29T09:15:37.0612914+02:00''
    WHERE [IdLavorazione] = 7;
    SELECT @@ROWCOUNT');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20251018073608_AddMakeOrBuyToAnagraficaArticoli'
)
BEGIN
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-09-18T09:36:07.1217888+02:00''
    WHERE [IdLavorazione] = 1;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-09-23T09:36:07.1217894+02:00''
    WHERE [IdLavorazione] = 2;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-09-28T09:36:07.1217898+02:00''
    WHERE [IdLavorazione] = 3;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-10-03T09:36:07.1217901+02:00''
    WHERE [IdLavorazione] = 4;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-10-08T09:36:07.1217904+02:00''
    WHERE [IdLavorazione] = 5;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-10-13T09:36:07.1217907+02:00''
    WHERE [IdLavorazione] = 6;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-08-29T09:36:07.1217911+02:00''
    WHERE [IdLavorazione] = 7;
    SELECT @@ROWCOUNT');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20251018074916_RemoveFieldsFromOrdiniRighe'
)
BEGIN
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-09-18T09:49:15.6372748+02:00''
    WHERE [IdLavorazione] = 1;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-09-23T09:49:15.6372756+02:00''
    WHERE [IdLavorazione] = 2;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-09-28T09:49:15.6372768+02:00''
    WHERE [IdLavorazione] = 3;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-10-03T09:49:15.6372781+02:00''
    WHERE [IdLavorazione] = 4;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-10-08T09:49:15.6372784+02:00''
    WHERE [IdLavorazione] = 5;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-10-13T09:49:15.6372792+02:00''
    WHERE [IdLavorazione] = 6;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-08-29T09:49:15.6372801+02:00''
    WHERE [IdLavorazione] = 7;
    SELECT @@ROWCOUNT');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20251018075703_RenameColumnsInOrdiniRighe'
)
BEGIN
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-09-18T09:57:02.4400225+02:00''
    WHERE [IdLavorazione] = 1;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-09-23T09:57:02.4400232+02:00''
    WHERE [IdLavorazione] = 2;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-09-28T09:57:02.4400235+02:00''
    WHERE [IdLavorazione] = 3;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-10-03T09:57:02.4400238+02:00''
    WHERE [IdLavorazione] = 4;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-10-08T09:57:02.4400242+02:00''
    WHERE [IdLavorazione] = 5;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-10-13T09:57:02.4400245+02:00''
    WHERE [IdLavorazione] = 6;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-08-29T09:57:02.4400248+02:00''
    WHERE [IdLavorazione] = 7;
    SELECT @@ROWCOUNT');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20251018081844_ChangeCentriLavoroPrimaryKeyToCodiceCentro'
)
BEGIN
...
BEGIN
    ...
    EXEC(N'UPDATE [CentriLavoro] SET [CodiceCentro] = N'''' WHERE [CodiceCentro] IS NULL');
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-09-18T10:18:42.7312634+02:00''
    WHERE [IdLavorazione] = 1;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-09-23T10:18:42.7312644+02:00''
    WHERE [IdLavorazione] = 2;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-09-28T10:18:42.7312649+02:00''
    WHERE [IdLavorazione] = 3;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-10-03T10:18:42.7312653+02:00''
    WHERE [IdLavorazione] = 4;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-10-08T10:18:42.7312658+02:00''
    WHERE [IdLavorazione] = 5;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-10-13T10:18:42.7312663+02:00''
    WHERE [IdLavorazione] = 6;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Lavorazioni] SET [DataCreazione] = ''2025-08-29T10:18:42.7312667+02:00''
    WHERE [IdLavorazione] = 7;
    SELECT @@ROWCOUNT');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20251018084704_ChangeLavorazioniPrimaryKeyToCodiceLavorazione'
)
BEGIN
...
BEGIN
    ...
    EXEC(N'UPDATE [Lavorazioni] SET [CodiceLavorazione] = '''' WHERE [CodiceLavorazione] IS NULL');
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20251018115410_RemoveFieldsFromOrdiniTestate'
)
BEGIN
                    DECLARE @fkName NVARCHAR(200);
                    SELECT @fkName = fk.name
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20251018115804_RenameColumnsInOrdiniTestate'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20251018120113_AddModificatoToListaOP'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20251018120858_UpdateAnagraficaClientiFields'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20251018121354_UpdateAnagraficaFornitoriFields'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20251018121630_RenameNoteColumnInArticoliSostitutivi'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20251018122342_CreateCalendarioFermiCentriLavoro'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20251020081123_ChangeCodiceLavorazioneToSmallInt'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20251020085555_RenameColumnMoMagazToCodiceMagazzino'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20251027083712_ChangeModificatoToInt'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20251101095836_AddTempiAsciugaturaTable'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20251101100348_SeedTempiAsciugatura'
)
BEGIN
    ...
    EXEC(N'INSERT INTO [TempiAsciugatura] ([IdMese], [Mese], [GiorniAsciugatura])
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20251101165920_AggiornaTipoFermoEnum'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20251107101628_AddCodiceAgenteToApplicationUser'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20251107162544_AddPermissionSystem'
)
BEGIN
